...
alpha1 = 0.002; beta1 = 0.5; alpha2 = 0.3; beta2 = 0.3; A1 = 0.15; % elliptical OU parameters (FEEL FREE TO TRY DIFFERENT VALUES)
%% GENERATION CODE
rng(1); % seed
...
%% Trajectory plot
F1b=figure; plot3(Delta*(900001:1000000),real(ZZ(end-99999:end)),imag(ZZ(end-99999:end)),'k'); grid('on');
...
set(gca,'fontsize', 16)
saveas(F1b,'WILCOU_EM1b.eps','epsc')
%% Spectrum plot
...
F2b=figure; plot(omegaN,10*log10(SZC),'k'); % plot of periodogram
...
set(gca,'fontsize', 16)
saveas(F2b,'WILCOU_EM2b.eps','epsc')